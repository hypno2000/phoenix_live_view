var LiveView = (() => {
  ...
  var EventTargetListeners2 = class {
    constructor() {
      ...
      __publicField(this, _b, /* @__PURE__ */ new WeakSet());
    }
    get [(_a = EventTargetDescriptors, _b = EventTargetListenersIgnore, EventTargetListeners)]() {
      var _a6;
      return [...(_a6 = this[EventTargetDescriptors]) != null ? _a6 : []];
    }
    [EventTargetListenersMatch](type) {
      var _a6;
      const external = this[EventTargetListeners];
      const matched = [
        .../* @__PURE__ */ new Set([...external != null ? external : [], ...(_a6 = this[EventTargetDescriptors]) != null ? _a6 : []])
      ].filter((descriptor) => descriptor.type === type || descriptor.type === "*").filter((descriptor) => {
        var _a7;
        return !((_a7 = this[EventTargetListenersIgnore]) == null ? void 0 : _a7.has(descriptor));
      });
    ...
    addEventListener(type, callback, options) {
      var _a6;
      const listener = __spreadProps(__spreadValues({}, options), {
        isListening: () => {
          var _a7;
          return !!((_a7 = this[EventTargetDescriptors]) == null ? void 0 : _a7.find(matchEventCallback(type, callback)));
        },
        descriptor: __spreadProps(__spreadValues({
          [EventDescriptorSymbol]: true
        }, options), {
          type,
          callback
      ...
      (_a6 = this[EventTargetDescriptors]) == null ? void 0 : _a6.push(listener.descriptor);
    }
    removeEventListener(type, callback, options) {
      var _a6, _b4, _c3, _d2, _e2, _f2;
      if (!isFunctionEventCallback(callback)) {
        return;
      }
      const externalListeners = (_b4 = (_a6 = this[EventTargetListeners]) != null ? _a6 : this[EventTargetDescriptors]) != null ? _b4 : [];
      const externalIndex = externalListeners.findIndex(matchEventCallback(type, callback, options));
      if (externalIndex === -1) {
        return;
      }
      const index = (_d2 = (_c3 = this[EventTargetDescriptors]) == null ? void 0 : _c3.findIndex(matchEventCallback(type, callback, options))) != null ? _d2 : -1;
      if (index !== -1) {
        (_e2 = this[EventTargetDescriptors]) == null ? void 0 : _e2.splice(index, 1);
      }
      const descriptor = externalListeners[externalIndex];
      if (descriptor) {
        (_f2 = this[EventTargetListenersIgnore]) == null ? void 0 : _f2.add(descriptor);
      }
    }
    hasEventListener(type, callback) {
      ...
      const foundIndex = (_b4 = (_a6 = this[EventTargetDescriptors]) == null ? void 0 : _a6.findIndex(matchEventCallback(type, callback))) != null ? _b4 : -1;
      return foundIndex > -1;
    }
  };
  ...
  var AsyncEventTarget = class extends EventTargetListeners2 {
    ...
    dispatchEvent(event) {
      return __async(this, null, function* () {
        var _a6, _b4;
        const listeners = (_b4 = (_a6 = this[EventTargetListenersMatch]) == null ? void 0 : _a6.call(this, event.type)) != null ? _b4 : [];
        ...
        for (let index = 0; index < listeners.length; index += 1) {
          ...
          const promise = (() => __async(this, null, function* () {
            ...
            yield descriptor.callback.call((_a7 = this[EventTargetListenersThis]) != null ? _a7 : this, event);
          }))();
          if (!parallel) {
            try {
              yield promise;
        ...
        if (promises.length) {
          ...
          if (rejected.length) {
            ...
            if (unhandled.length === 1) {
              yield Promise.reject(unhandled[0].reason);
  ...
  var SyncEventTarget = class extends EventTargetListeners2 {
    ...
    dispatchEvent(event) {
      ...
      for (let index = 0; index < listeners.length; index += 1) {
        ...
        try {
          descriptor.callback.call((_c3 = this[EventTargetListenersThis]) != null ? _c3 : this, event);
        } catch (error) {
          if (!isSignalHandled(event, error)) {
            throw error;
          }
  ...
  var NavigationHistoryEntry = class extends NavigationEventTarget {
    constructor(init) {
      ...
      __privateSet(this, _options, init);
      this.key = init.key || v4();
      this.id = v4();
      this.url = (_a6 = init.url) != null ? _a6 : void 0;
      __privateSet(this, _index, init.index);
      this.sameDocument = (_b4 = init.sameDocument) != null ? _b4 : true;
      __privateSet(this, _state, (_c3 = init.state) != null ? _c3 : void 0);
    }
    get index() {
      return typeof __privateGet(this, _index) === "number" ? __privateGet(this, _index) : __privateGet(this, _index).call(this);
    }
    get [NavigationHistoryEntryNavigationType]() {
      return __privateGet(this, _options).navigationType;
    }
    get [NavigationHistoryEntryKnownAs]() {
      const set = new Set(__privateGet(this, _options)[NavigationHistoryEntryKnownAs]);
      set.add(this.id);
      return set;
    }
    get [EventTargetListeners]() {
      var _a6, _b4;
      return [
        ...(_a6 = super[EventTargetListeners]) != null ? _a6 : [],
        ...(_b4 = __privateGet(this, _options)[EventTargetListeners]) != null ? _b4 : []
      ];
    }
    [NavigationGetState]() {
      var _a6, _b4;
      return (_b4 = (_a6 = __privateGet(this, _options)) == null ? void 0 : _a6.getState) == null ? void 0 : _b4.call(_a6, this);
    }
    getState() {
      let state = __privateGet(this, _state);
      if (!isValue(state)) {
        const external = this[NavigationGetState]();
        if (isValue(external)) {
          state = __privateSet(this, _state, external);
        }
      }
  ...
  var _a4, _b2, _options2, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _promises, _rolledBack, _abortController, _onCommitSetProperty, _onFinishSetProperty, _onFinishPromise, _onCommitPromise, _onError, _m, _n, _o, _p, _q;
  var NavigationTransition = class extends EventTarget {
    constructor(init) {
      ...
      __publicField(this, _c, deferred());
      __publicField(this, _d, deferred());
      ...
      __publicField(this, _k, /* @__PURE__ */ new Set());
      __publicField(this, _l);
      __privateAdd(this, _promises, /* @__PURE__ */ new Set());
      __privateAdd(this, _rolledBack, false);
      __privateAdd(this, _abortController, new AbortController2());
      __publicField(this, "rollback", (options) => {
        if (__privateGet(this, _rolledBack)) {
        ...
        __privateSet(this, _rolledBack, true);
        return __privateGet(this, _options2).rollback(options);
      });
      __privateAdd(this, _onCommitSetProperty, () => {
        this[NavigationTransitionIsCommitted] = true;
      });
      __privateAdd(this, _onFinishSetProperty, () => {
        this[NavigationTransitionIsFinished] = true;
      });
      __privateAdd(this, _onFinishPromise, () => {
        this[NavigationTransitionFinishedDeferred].resolve(this[NavigationTransitionEntry]);
      });
      __privateAdd(this, _onCommitPromise, () => {
        if (this.signal.aborted) {
        } else {
          this[NavigationTransitionCommittedDeferred].resolve(this[NavigationTransitionEntry]);
        }
      });
      __privateAdd(this, _onError, (event) => {
        return this[NavigationTransitionRejected](event.error);
      });
      __publicField(this, _m, (...promises) => {
        for (const promise of promises) {
          __privateGet(this, _promises).delete(promise);
        }
      });
      __publicField(this, _n, (reason) => __async(this, null, function* () {
        var _a6;
        ...
        if (typeof navigationType === "string" || navigationType === Rollback) {
          ...
          if (navigationType !== Rollback && !(isInvalidStateError(reason) || isAbortError(reason))) {
            try {
              yield (_a6 = this.rollback()) == null ? void 0 : _a6.finished;
            } catch (error) {
      ...
      __publicField(this, _o, (options) => {
        ...
        const statusPromise = promise.then(() => ({
          status: "fulfilled",
          value: void 0
        })).catch((reason) => __async(this, null, function* () {
          yield this[NavigationTransitionRejected](reason);
          return {
            status: "rejected",
            reason
          };
        }));
        __privateGet(this, _promises).add(statusPromise);
      ...
      __publicField(this, _p, () => __async(this, null, function* () {
        if (!__privateGet(this, _promises).size)
          return this[NavigationTransitionEntry];
        try {
          const captured = [...__privateGet(this, _promises)];
          const results = yield Promise.all(captured);
          ...
          yield __privateGet(this, _onError).call(this, error);
          throw yield Promise.reject(error);
        } finally {
          yield this[NavigationTransitionFinish]();
        }
      }));
      __publicField(this, _q, () => __async(this, null, function* () {
      ...
      this[NavigationTransitionFinishedDeferred] = (_a6 = init[NavigationTransitionFinishedDeferred]) != null ? _a6 : this[NavigationTransitionFinishedDeferred];
      this[NavigationTransitionCommittedDeferred] = (_b4 = init[NavigationTransitionCommittedDeferred]) != null ? _b4 : this[NavigationTransitionCommittedDeferred];
      __privateSet(this, _options2, init);
      ...
      {
        {
          this.addEventListener(NavigationTransitionCommit, __privateGet(this, _onCommitPromise), { once: true });
          this.addEventListener(NavigationTransitionFinish, __privateGet(this, _onFinishPromise), { once: true });
        }
        {
          this.addEventListener(NavigationTransitionCommit, __privateGet(this, _onCommitSetProperty), { once: true });
          this.addEventListener(NavigationTransitionFinish, __privateGet(this, _onFinishSetProperty), { once: true });
        }
        {
          this.addEventListener(NavigationTransitionError, __privateGet(this, _onError), {
            once: true
          });
    ...
    get [(_a4 = NavigationTransitionIsAsync, _b2 = NavigationTransitionInterceptOptionsCommit, _c = NavigationTransitionFinishedDeferred, _d = NavigationTransitionCommittedDeferred, NavigationTransitionIsPending)]() {
      return !!__privateGet(this, _promises).size;
    }
    get [NavigationTransitionNavigationType]() {
      return __privateGet(this, _options2)[NavigationTransitionNavigationType];
    }
    get [NavigationTransitionInitialEntries]() {
      return __privateGet(this, _options2)[NavigationTransitionInitialEntries];
    }
    get [NavigationTransitionInitialIndex]() {
      return __privateGet(this, _options2)[NavigationTransitionInitialIndex];
    }
    get [NavigationTransitionCommitIsManual]() {
      var _a6, _b4;
      return !!(((_a6 = this[NavigationTransitionInterceptOptionsCommit]) == null ? void 0 : _a6.includes("after-transition")) || ((_b4 = this[NavigationTransitionInterceptOptionsCommit]) == null ? void 0 : _b4.includes("manual")));
    }
    get signal() {
      return __privateGet(this, _abortController).signal;
    }
    get [(_e = NavigationTransitionFinishedEntries, _f = NavigationTransitionFinishedIndex, _g = NavigationTransitionIsCommitted, _h = NavigationTransitionIsFinished, _i = NavigationTransitionIsRejected, _j = NavigationTransitionIsOngoing, _k = NavigationTransitionKnown, _l = NavigationTransitionEntry, NavigationTransitionPromises)]() {
      return __privateGet(this, _promises);
    }
    [(_m = NavigationTransitionPromiseResolved, _n = NavigationTransitionRejected, _o = NavigationIntercept, _p = NavigationTransitionWait, NavigationTransitionAbort)]() {
  ...
  _q = NavigationTransitionFinish;
  _options2 = new WeakMap();
  _promises = new WeakMap();
  _rolledBack = new WeakMap();
  _abortController = new WeakMap();
  _onCommitSetProperty = new WeakMap();
  _onFinishSetProperty = new WeakMap();
  _onFinishPromise = new WeakMap();
  _onCommitPromise = new WeakMap();
  ...
  function getBaseURL(url) {
    var _a6;
    const baseURL = (_a6 = getWindowBaseURL()) != null ? _a6 : "https://html.spec.whatwg.org/";
    return new URL(
  ...
  var NavigationCurrentEntryChangeEvent = class {
    constructor(type, init) {
      ...
      this.from = init.from;
      this.navigationType = (_a6 = init.navigationType) != null ? _a6 : void 0;
    }
  };
  ...
  var NavigateEvent = class {
    constructor(type, init) {
      __publicField(this, "type");
      __publicField(this, "canIntercept");
      /**
       * @deprecated
       */
      __publicField(this, "canTransition");
      __publicField(this, "destination");
      __publicField(this, "downloadRequest");
      __publicField(this, "formData");
      __publicField(this, "hashChange");
      __publicField(this, "info");
      __publicField(this, "signal");
      __publicField(this, "userInitiated");
      __publicField(this, "navigationType");
      var _a6, _b4, _c3, _d2, _e2;
      this.type = type;
      if (!init) {
        throw new TypeError("init required");
      }
      ...
      this.canIntercept = (_a6 = init.canIntercept) != null ? _a6 : false;
      this.canTransition = (_b4 = init.canIntercept) != null ? _b4 : false;
      this.destination = init.destination;
      this.downloadRequest = init.downloadRequest;
      this.formData = init.formData;
      this.hashChange = (_c3 = init.hashChange) != null ? _c3 : false;
      this.info = init.info;
      this.signal = init.signal;
      this.userInitiated = (_d2 = init.userInitiated) != null ? _d2 : false;
      this.navigationType = (_e2 = init.navigationType) != null ? _e2 : "push";
    }
    commit() {
  ...
  function createNavigationTransition(context) {
    ...
    if (navigationType === Rollback) {
      const { index } = options != null ? options : { index: void 0 };
    ...
    const currentUrlInstance = getBaseURL(currentEntry == null ? void 0 : currentEntry.url);
    ...
    const event = new NavigateEvent("navigate", __spreadProps(__spreadValues({
      signal: abortController.signal,
      info: void 0
    }, options), {
      canIntercept: (_a6 = options == null ? void 0 : options[NavigationCanIntercept]) != null ? _a6 : true,
      formData: (_b4 = options == null ? void 0 : options[NavigationFormData]) != null ? _b4 : void 0,
      downloadRequest: (_c3 = options == null ? void 0 : options[NavigationDownloadRequest]) != null ? _c3 : void 0,
      hashChange,
      navigationType: (_d2 = options == null ? void 0 : options.navigationType) != null ? _d2 : typeof navigationType === "string" ? navigationType : "replace",
      userInitiated: (_e2 = options == null ? void 0 : options[NavigationUserInitiated]) != null ? _e2 : false,
      destination
    }));
    const originalEvent = options == null ? void 0 : options[NavigationOriginalEvent];
    ...
    if (navigationType === Rollback) {
      const { entries } = options != null ? options : { entries: void 0 };
      if (!entries)
  ...
  function createEvent(event) {
    if (typeof CustomEvent !== "undefined" && typeof event.type === "string") {
      ...
      const _a6 = event, { type, detail } = _a6, rest = __objRest(_a6, ["type", "detail"]);
      const customEvent = new CustomEvent(type, {
        detail: detail != null ? detail : rest
      });
  ...
  var _transitionInProgressCount, _entries, _known, _currentIndex, _activeTransition, _knownTransitions, _baseURL, _initialEntry, _options3, _a5, _b3, _c2, _isSameDocument, _cloneNavigationHistoryEntry, _createNavigationHistoryEntry, _pushEntry, _commitTransition, _queueTransition, _immediateTransition, _rollback, _transition, _dispose;
  var Navigation = class extends NavigationEventTarget {
    constructor(options = {}) {
      super();
      // Should be always 0 or 1
      __privateAdd(this, _transitionInProgressCount, 0);
      // #activePromise?: Promise<void> = undefined;
      __privateAdd(this, _entries, []);
      __privateAdd(this, _known, /* @__PURE__ */ new Set());
      __privateAdd(this, _currentIndex, -1);
      __privateAdd(this, _activeTransition, void 0);
      __privateAdd(this, _knownTransitions, /* @__PURE__ */ new WeakSet());
      __privateAdd(this, _baseURL, "");
      __privateAdd(this, _initialEntry, void 0);
      __privateAdd(this, _options3, void 0);
      __publicField(this, _a5, (entry) => {
        var _a6, _b4, _c3;
        return (_c3 = (_b4 = (_a6 = __privateGet(this, _options3)) == null ? void 0 : _a6.getState) == null ? void 0 : _b4.call(_a6, entry)) != null ? _c3 : void 0;
      });
      __publicField(this, _b3, (entry) => {
        var _a6, _b4;
        return (_b4 = (_a6 = __privateGet(this, _options3)) == null ? void 0 : _a6.setState) == null ? void 0 : _b4.call(_a6, entry);
      });
      __publicField(this, _c2, (entry) => {
        var _a6, _b4;
        return (_b4 = (_a6 = __privateGet(this, _options3)) == null ? void 0 : _a6.disposeState) == null ? void 0 : _b4.call(_a6, entry);
      });
      __privateAdd(this, _isSameDocument, (url) => {
        var _a6;
        function isSameOrigins(a, b) {
          return a.origin === b.origin;
        }
        const currentEntryUrl = (_a6 = this.currentEntry) == null ? void 0 : _a6.url;
        if (!currentEntryUrl)
          return true;
        return isSameOrigins(new URL(currentEntryUrl), new URL(url));
      });
      __privateAdd(this, _cloneNavigationHistoryEntry, (entry, options) => {
        var _a6, _b4, _c3;
        return __privateGet(this, _createNavigationHistoryEntry).call(this, __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, entry), {
          getState: this[NavigationGetState2],
          index: (_a6 = entry == null ? void 0 : entry.index) != null ? _a6 : void 0,
          state: (_b4 = options == null ? void 0 : options.state) != null ? _b4 : entry == null ? void 0 : entry.getState(),
          navigationType: (_c3 = entry == null ? void 0 : entry[NavigationHistoryEntryNavigationType]) != null ? _c3 : typeof (options == null ? void 0 : options.navigationType) === "string" ? options.navigationType : "replace"
        }), options), {
          get [NavigationHistoryEntryKnownAs]() {
            return entry == null ? void 0 : entry[NavigationHistoryEntryKnownAs];
          },
          get [EventTargetListeners]() {
            return entry == null ? void 0 : entry[EventTargetListeners];
          }
        }));
      });
      __privateAdd(this, _createNavigationHistoryEntry, (options) => {
        var _a6;
        const entry = new NavigationHistoryEntry(__spreadProps(__spreadValues({}, options), {
          index: (_a6 = options.index) != null ? _a6 : () => {
            return __privateGet(this, _entries).indexOf(entry);
          }
        }));
        return entry;
      });
      __privateAdd(this, _pushEntry, (navigationType, entry, transition, options) => {
        if (entry === this.currentEntry)
          throw new InvalidStateError();
        const existingPosition = __privateGet(this, _entries).findIndex((existing) => existing.id === entry.id);
        if (existingPosition > -1) {
          throw new InvalidStateError();
        }
        return __privateGet(this, _commitTransition).call(this, navigationType, entry, transition, options);
      });
      __privateAdd(this, _commitTransition, (givenNavigationType, entry, transition, options) => {
        const nextTransition = transition != null ? transition : new NavigationTransition({
          from: entry,
          navigationType: typeof givenNavigationType === "string" ? givenNavigationType : "replace",
          rollback: (options2) => {
            return __privateGet(this, _rollback).call(this, nextTransition, options2);
          },
          [NavigationTransitionNavigationType]: givenNavigationType,
          [NavigationTransitionInitialEntries]: [...__privateGet(this, _entries)],
          [NavigationTransitionInitialIndex]: __privateGet(this, _currentIndex),
          [NavigationTransitionKnown]: [...__privateGet(this, _known)],
          [NavigationTransitionEntry]: entry,
          [NavigationTransitionParentEventTarget]: this
        });
        const { finished, committed } = nextTransition;
        const handler = () => {
          return __privateGet(this, _immediateTransition).call(this, givenNavigationType, entry, nextTransition, options);
        };
        __privateGet(this, _queueTransition).call(this, nextTransition);
        void handler().catch((error) => void 0);
        return { committed, finished };
      });
      __privateAdd(this, _queueTransition, (transition) => {
        __privateGet(this, _knownTransitions).add(transition);
      });
      __privateAdd(this, _immediateTransition, (givenNavigationType, entry, transition, options) => {
        try {
          __privateSet(this, _transitionInProgressCount, __privateGet(this, _transitionInProgressCount) + 1);
          return __privateGet(this, _transition).call(this, givenNavigationType, entry, transition, options);
        } finally {
          __privateSet(this, _transitionInProgressCount, __privateGet(this, _transitionInProgressCount) - 1);
        }
      });
      __privateAdd(this, _rollback, (rollbackTransition, options) => {
        var _a6;
        ...
        const entry = previousCurrent ? __privateGet(this, _cloneNavigationHistoryEntry).call(this, previousCurrent, options) : void 0;
        const nextOptions = __spreadProps(__spreadValues({}, options), {
          index: previousIndex,
          known: /* @__PURE__ */ new Set([...__privateGet(this, _known), ...previousEntries]),
          navigationType: (_a6 = entry == null ? void 0 : entry[NavigationHistoryEntryNavigationType]) != null ? _a6 : "replace",
          entries: previousEntries
        });
        const resolvedNavigationType = entry ? Rollback : Unset;
        const resolvedEntry = entry != null ? entry : __privateGet(this, _createNavigationHistoryEntry).call(this, __spreadValues({
          getState: this[NavigationGetState2],
          navigationType: "replace",
          index: nextOptions.index,
          sameDocument: true
        }, options));
        return __privateGet(this, _pushEntry).call(this, resolvedNavigationType, resolvedEntry, void 0, nextOptions);
      });
      __privateAdd(this, _transition, (givenNavigationType, entry, transition, options) => {
        var _a6, _b4, _c3, _d2, _e2, _f2, _g2, _h2, _i2, _j2;
        ...
        if (performance2 && entry.sameDocument && typeof navigationType === "string") {
          (_a6 = performance2 == null ? void 0 : performance2.mark) == null ? void 0 : _a6.call(performance2, `same-document-navigation:${entry.id}`);
        }
        let currentEntryChangeEvent = false, committedCurrentEntryChange = false;
        const { currentEntry } = this;
        void ((_c3 = (_b4 = __privateGet(this, _activeTransition)) == null ? void 0 : _b4.finished) == null ? void 0 : _c3.catch((error) => error));
        void ((_f2 = (_e2 = (_d2 = __privateGet(this, _activeTransition)) == null ? void 0 : _d2[NavigationTransitionFinishedDeferred]) == null ? void 0 : _e2.promise) == null ? void 0 : _f2.catch((error) => error));
        void ((_i2 = (_h2 = (_g2 = __privateGet(this, _activeTransition)) == null ? void 0 : _g2[NavigationTransitionCommittedDeferred]) == null ? void 0 : _h2.promise) == null ? void 0 : _i2.catch((error) => error));
        (_j2 = __privateGet(this, _activeTransition)) == null ? void 0 : _j2[NavigationTransitionAbort]();
        __privateSet(this, _activeTransition, transition);
        ...
        const syncCommit = ({ entries, index, known }) => {
          ...
          if (known) {
            __privateSet(this, _known, /* @__PURE__ */ new Set([...__privateGet(this, _known), ...known]));
          }
          __privateSet(this, _currentIndex, index);
          this[NavigationSetState](this.currentEntry);
        };
        const asyncCommit = (commit) => __async(this, null, function* () {
          ...
          if (entriesChange) {
            promises.push(this.dispatchEvent(createEvent(__spreadValues({
              type: "entrieschange"
            }, entriesChange))));
          }
          yield Promise.all(promises);
        });
        const unsetTransition = () => __async(this, null, function* () {
          yield startEventPromise;
          if (!(typeof (options == null ? void 0 : options.index) === "number" && options.entries))
            throw new InvalidStateError();
          ...
          yield this.dispatchEvent(createEvent({
        ...
        const completeTransition = () => {
          ...
          const transitionResult = createNavigationTransition({
            currentEntry,
            currentIndex: __privateGet(this, _currentIndex),
            options,
            transition,
            known: __privateGet(this, _known),
            commit: asyncCommit,
          ...
          function asyncTransition() {
            return __async(this, null, function* () {
              ...
              if (captured.length) {
                ...
                if (rejected.length === 1) {
                  throw yield Promise.reject(rejected[0]);
                } else if (rejected.length) {
                  throw new AggregateError(rejected, (_a7 = rejected[0].reason) == null ? void 0 : _a7.message);
                }
        ...
        const dispose = () => __async(this, null, function* () {
          return __privateGet(this, _dispose).call(this);
        });
        function* transitionSteps(transitionResult) {
          ...
          if (typeof navigationType === "string" || navigationType === Rollback) {
            const promise = currentEntry == null ? void 0 : currentEntry.dispatchEvent(createEvent({
              type: "navigatefrom",
        ...
        return Promise.allSettled([maybeSyncTransition()]).then((_0) => __async(this, [_0], function* ([detail]) {
          ...
          yield transition[NavigationTransitionWait]();
          if (__privateGet(this, _activeTransition) === transition) {
            __privateSet(this, _activeTransition, void 0);
          }
      ...
      __privateAdd(this, _dispose, () => __async(this, null, function* () {
        for (const known of __privateGet(this, _known)) {
          const index = __privateGet(this, _entries).findIndex((entry) => entry.key === known.key);
          if (index !== -1) {
            continue;
          }
          __privateGet(this, _known).delete(known);
          const event = createEvent({
            type: "dispose",
            entry: known
          });
          this[NavigationDisposeState](known);
          yield known.dispatchEvent(event);
          yield this.dispatchEvent(event);
        }
      }));
      this[NavigationSetOptions](options);
    }
    get canGoBack() {
      return !!__privateGet(this, _entries)[__privateGet(this, _currentIndex) - 1];
    }
    get canGoForward() {
      return !!__privateGet(this, _entries)[__privateGet(this, _currentIndex) + 1];
    }
    get currentEntry() {
      if (__privateGet(this, _currentIndex) === -1) {
        if (!__privateGet(this, _initialEntry)) {
          __privateSet(this, _initialEntry, new NavigationHistoryEntry({
            getState: this[NavigationGetState2],
            navigationType: "push",
            index: -1,
            sameDocument: false,
            url: __privateGet(this, _baseURL).toString()
          }));
        }
        return __privateGet(this, _initialEntry);
      }
      return __privateGet(this, _entries)[__privateGet(this, _currentIndex)];
    }
    get transition() {
      const transition = __privateGet(this, _activeTransition);
      return (transition == null ? void 0 : transition.signal.aborted) ? void 0 : transition;
    }
    [NavigationSetOptions](options) {
      __privateSet(this, _options3, options);
      __privateSet(this, _baseURL, getBaseURL(options == null ? void 0 : options.baseURL));
    ...
    [NavigationSetCurrentKey](key) {
      const index = __privateGet(this, _entries).findIndex((entry) => entry.key === key);
      if (index === -1)
        return;
      __privateSet(this, _currentIndex, index);
    }
    ...
    [NavigationSetCurrentIndex](index) {
      if (index <= -1)
        return;
      if (index >= __privateGet(this, _entries).length)
        return;
      __privateSet(this, _currentIndex, index);
    }
    /**
    ...
    [NavigationSetEntries](entries) {
      __privateSet(this, _entries, entries.map(({ key, url, navigationType, state, sameDocument }, index) => new NavigationHistoryEntry({
        getState: this[NavigationGetState2],
        navigationType: isNavigationNavigationType(navigationType) ? navigationType : "push",
        sameDocument: sameDocument != null ? sameDocument : true,
        index,
        url,
        key,
        state
      })));
      if (__privateGet(this, _currentIndex) === -1 && __privateGet(this, _entries).length) {
    ...
    back(options) {
      ...
      const entry = __privateGet(this, _entries)[__privateGet(this, _currentIndex) - 1];
      return __privateGet(this, _pushEntry).call(this, "traverse", __privateGet(this, _cloneNavigationHistoryEntry).call(this, entry, __spreadProps(__spreadValues({}, options), {
    ...
    traverseTo(key, options) {
      const found = __privateGet(this, _entries).find((entry) => entry.key === key);
      if (found) {
        return __privateGet(this, _pushEntry).call(this, "traverse", __privateGet(this, _cloneNavigationHistoryEntry).call(this, found, __spreadProps(__spreadValues({}, options), {
          navigationType: "traverse"
        })));
      }
      throw new InvalidStateError();
    ...
    navigate(url, options) {
      var _a6, _b4;
      let baseURL = __privateGet(this, _baseURL);
      if ((_a6 = this.currentEntry) == null ? void 0 : _a6.url) {
        baseURL = (_b4 = this.currentEntry) == null ? void 0 : _b4.url;
      }
      const nextUrl = new URL(url, baseURL).toString();
      let navigationType = "push";
      if ((options == null ? void 0 : options.history) === "push" || (options == null ? void 0 : options.history) === "replace") {
        navigationType = options == null ? void 0 : options.history;
      }
      const entry = __privateGet(this, _createNavigationHistoryEntry).call(this, __spreadProps(__spreadValues({
        getState: this[NavigationGetState2],
        url: nextUrl
      }, options), {
        sameDocument: __privateGet(this, _isSameDocument).call(this, nextUrl),
        navigationType
      }));
      return __privateGet(this, _pushEntry).call(this, navigationType, entry, void 0, options);
    }
    reload(options) {
      const { currentEntry } = this;
      if (!currentEntry)
        throw new InvalidStateError();
      const entry = __privateGet(this, _cloneNavigationHistoryEntry).call(this, currentEntry, options);
      return __privateGet(this, _pushEntry).call(this, "reload", entry, void 0, options);
    }
  ...
  _a5 = NavigationGetState2, _b3 = NavigationSetState, _c2 = NavigationDisposeState;
  _transitionInProgressCount = new WeakMap();
  _entries = new WeakMap();
  _known = new WeakMap();
  _currentIndex = new WeakMap();
  _activeTransition = new WeakMap();
  _knownTransitions = new WeakMap();
  _baseURL = new WeakMap();
  _initialEntry = new WeakMap();
  _options3 = new WeakMap();
  _isSameDocument = new WeakMap();
  _cloneNavigationHistoryEntry = new WeakMap();
  _createNavigationHistoryEntry = new WeakMap();
  _pushEntry = new WeakMap();
  _commitTransition = new WeakMap();
  _queueTransition = new WeakMap();
  _immediateTransition = new WeakMap();
  _rollback = new WeakMap();
  ...
  var _options4, _navigation, _urls, _transitioningURL, _baseURL2, _setUrlValue, _transitionURL, _awaitFinished, _triggerIfUrlChanged;
  var NavigationLocation = class {
    constructor(options) {
      __privateAdd(this, _options4, void 0);
      __privateAdd(this, _navigation, void 0);
      __privateAdd(this, _urls, /* @__PURE__ */ new WeakMap());
      __privateAdd(this, _transitioningURL, void 0);
      __privateAdd(this, _baseURL2, void 0);
      __privateAdd(this, _setUrlValue, (key, value) => {
        ...
        void __privateGet(this, _transitionURL).call(this, nextUrl, () => __privateGet(this, _navigation).navigate(nextUrlString));
      });
      __privateAdd(this, _transitionURL, (url, fn) => __async(this, null, function* () {
        const instance = __privateSet(this, _transitioningURL, typeof url === "string" ? new URL(url, this[AppLocationUrl].toString()) : url);
        try {
          yield __privateGet(this, _awaitFinished).call(this, fn(instance));
        } finally {
          if (__privateGet(this, _transitioningURL) === instance) {
            __privateSet(this, _transitioningURL, void 0);
          }
        }
      }));
      __privateAdd(this, _awaitFinished, (result) => __async(this, null, function* () {
        __privateSet(this, _baseURL2, void 0);
        if (!result)
          return;
      ...
      __privateAdd(this, _triggerIfUrlChanged, () => {
        var _a6;
        const current = this[AppLocationUrl];
        const currentUrl = current.toString();
        const expectedUrl = (_a6 = __privateGet(this, _navigation).currentEntry) == null ? void 0 : _a6.url;
        if (currentUrl !== expectedUrl) {
          return __privateGet(this, _transitionURL).call(this, current, () => __privateGet(this, _navigation).navigate(currentUrl));
        }
      });
      __privateSet(this, _options4, options);
      __privateSet(this, _navigation, options.navigation);
      const reset = () => {
        __privateSet(this, _transitioningURL, void 0);
        __privateSet(this, _baseURL2, void 0);
      };
      __privateGet(this, _navigation).addEventListener("navigate", () => {
        const transition = __privateGet(this, _navigation).transition;
      ...
      __privateGet(this, _navigation).addEventListener("currententrychange", reset);
    }
    get [AppLocationUrl]() {
      var _a6;
      if (__privateGet(this, _transitioningURL)) {
        return __privateGet(this, _transitioningURL);
      }
      const { currentEntry } = __privateGet(this, _navigation);
      if (!currentEntry) {
        __privateSet(this, _baseURL2, getBaseURL(__privateGet(this, _options4).baseURL));
        return __privateGet(this, _baseURL2);
      }
      const existing = __privateGet(this, _urls).get(currentEntry);
      if (existing)
        return existing;
      const next = new URL((_a6 = currentEntry.url) != null ? _a6 : NAVIGATION_LOCATION_DEFAULT_URL);
      __privateGet(this, _urls).set(currentEntry, next);
      return next;
    }
    get hash() {
    ...
    set hash(value) {
      __privateGet(this, _setUrlValue).call(this, "hash", value);
    }
    get host() {
      return this[AppLocationUrl].host;
    }
    set host(value) {
      __privateGet(this, _setUrlValue).call(this, "host", value);
    }
    get hostname() {
      return this[AppLocationUrl].hostname;
    }
    set hostname(value) {
      __privateGet(this, _setUrlValue).call(this, "hostname", value);
    }
    get href() {
      return this[AppLocationUrl].href;
    }
    set href(value) {
      __privateGet(this, _setUrlValue).call(this, "href", value);
    }
    get origin() {
    ...
    set pathname(value) {
      __privateGet(this, _setUrlValue).call(this, "pathname", value);
    }
    get port() {
      return this[AppLocationUrl].port;
    }
    set port(value) {
      __privateGet(this, _setUrlValue).call(this, "port", value);
    }
    get protocol() {
      return this[AppLocationUrl].protocol;
    }
    set protocol(value) {
      __privateGet(this, _setUrlValue).call(this, "protocol", value);
    }
    get search() {
      return this[AppLocationUrl].search;
    }
    set search(value) {
      __privateGet(this, _setUrlValue).call(this, "search", value);
    }
    replace(url) {
      return __privateGet(this, _transitionURL).call(this, url, (url2) => __privateGet(this, _navigation).navigate(url2.toString(), {
        history: "replace"
      }));
    }
    reload() {
      return __privateGet(this, _awaitFinished).call(this, __privateGet(this, _navigation).reload());
    }
    assign(url) {
      return __privateGet(this, _transitionURL).call(this, url, (url2) => __privateGet(this, _navigation).navigate(url2.toString()));
    }
    [AppLocationTransitionURL](url, fn) {
      return __privateGet(this, _transitionURL).call(this, url, fn);
    }
    [AppLocationAwaitFinished](result) {
      return __privateGet(this, _awaitFinished).call(this, result);
    }
    /**
    ...
    [AppLocationCheckChange]() {
      return __privateGet(this, _triggerIfUrlChanged).call(this);
    }
  };
  _options4 = new WeakMap();
  _navigation = new WeakMap();
  _urls = new WeakMap();
  _transitioningURL = new WeakMap();
  _baseURL2 = new WeakMap();
  _setUrlValue = new WeakMap();
  _transitionURL = new WeakMap();
  _awaitFinished = new WeakMap();
  _triggerIfUrlChanged = new WeakMap();

  // ../node_modules/@virtualstate/navigation/esnext/history.js
  var State = Symbol.for("@virtualstate/navigation/history/state");
  var _options5, _navigation2;
  var NavigationHistory = class extends NavigationLocation {
    constructor(options) {
      ...
      __publicField(this, "scrollRestoration", "manual");
      __privateSet(this, _options5, options);
      __privateSet(this, _navigation2, options.navigation);
    }
    get length() {
      return __privateGet(this, _navigation2).entries().length;
    }
    get state() {
      var _a6, _b4;
      const currentState = (_a6 = __privateGet(this, _navigation2).currentEntry) == null ? void 0 : _a6.getState();
      if (typeof currentState === "string" || typeof currentState === "number" || typeof currentState === "boolean") {
        return currentState;
      }
      return (_b4 = __privateGet(this, _options5)[State]) != null ? _b4 : void 0;
    }
    back() {
      var _a6, _b4;
      const entries = __privateGet(this, _navigation2).entries();
      const index = (_b4 = (_a6 = __privateGet(this, _navigation2).currentEntry) == null ? void 0 : _a6.index) != null ? _b4 : -1;
      const back = entries[index - 1];
      const url = back == null ? void 0 : back.url;
      if (!url)
        throw new InvalidStateError("Cannot go back");
      return this[AppLocationTransitionURL](url, () => __privateGet(this, _navigation2).back());
    }
    forward() {
      var _a6, _b4;
      const entries = __privateGet(this, _navigation2).entries();
      ...
      const url = forward == null ? void 0 : forward.url;
      if (!url)
        throw new InvalidStateError("Cannot go forward");
      return this[AppLocationTransitionURL](url, () => __privateGet(this, _navigation2).forward());
    }
    go(delta) {
      if (typeof delta !== "number" || delta === 0 || isNaN(delta)) {
        return this[AppLocationAwaitFinished](__privateGet(this, _navigation2).reload());
      }
      const entries = __privateGet(this, _navigation2).entries();
      const { currentEntry } = __privateGet(this, _navigation2);
      if (!currentEntry) {
      ...
      return this[AppLocationAwaitFinished](__privateGet(this, _navigation2).traverseTo(nextEntryKey));
    }
    replaceState(data, unused, url) {
      if (url) {
        return this[AppLocationTransitionURL](url, (url2) => __privateGet(this, _navigation2).navigate(url2.toString(), {
          state: data,
          history: "replace"
        }));
      } else {
        return __privateGet(this, _navigation2).updateCurrentEntry({
          state: data
        });
      }
    }
  ...
  function getHistoryState(history2, entry) {
    var _a6;
    return (_a6 = getStateFromHistoryIfMatchingKey()) != null ? _a6 : getStateFromSession();
    ...
    function getBaseState() {
      var _a7;
      const value = (_a7 = history2.originalState) != null ? _a7 : getStateFromHistoryDirectly();
  ...
  function getNavigationOnlyPolyfill(givenNavigation) {
    ...
    const navigation3 = givenNavigation != null ? givenNavigation : new Navigation({
      entries
    });
  ...
  function interceptWindowClicks(navigation3, window2) {
    ...
    window2.addEventListener("click", (ev) => {
      var _a6;
      if (((_a6 = ev.target) == null ? void 0 : _a6.ownerDocument) === window2.document) {
  ...
  function getComposedPathTarget(event) {
    ...
    return (_a6 = targets[0]) != null ? _a6 : event.target;
  }
  function patchGlobalScope(window2, history2, navigation3) {
    ...
    function patchHistory() {
      ...
      const descriptor = {
        pushState: __spreadProps(__spreadValues({}, Object.getOwnPropertyDescriptor(prototype, "pushState")), {
          value: pushState
        }),
        replaceState: __spreadProps(__spreadValues({}, Object.getOwnPropertyDescriptor(prototype, "replaceState")), {
          value: replaceState
        }),
        go: __spreadProps(__spreadValues({}, Object.getOwnPropertyDescriptor(prototype, "go")), {
          value: go
        }),
        back: __spreadProps(__spreadValues({}, Object.getOwnPropertyDescriptor(prototype, "back")), {
          value: back
        }),
        forward: __spreadProps(__spreadValues({}, Object.getOwnPropertyDescriptor(prototype, "forward")), {
          value: forward
        })
      };
      ...
      Object.defineProperty(history2, "state", __spreadProps(__spreadValues({}, stateDescriptor), {
        get() {
          return polyfillHistory.state;
        }
      }));
      Object.defineProperty(history2, "originalState", __spreadValues({}, stateDescriptor));
    }
    function patchPopState() {
      ...
      Object.defineProperty(popStateEventPrototype, "state", __spreadProps(__spreadValues({}, descriptor), {
        get() {
      ...
      Object.defineProperty(popStateEventPrototype, "originalState", __spreadValues({}, descriptor));
    }
  }
  function getCompletePolyfill(options = DEFAULT_POLYFILL_OPTIONS) {
    var _a6;
    const { persist: PERSIST_ENTRIES, persistState: PERSIST_ENTRIES_STATE, history: givenHistory, limit: patchLimit, patch: PATCH_HISTORY, interceptEvents: INTERCEPT_EVENTS, window: givenWindow = globalWindow, navigation: givenNavigation } = __spreadValues(__spreadValues({}, DEFAULT_POLYFILL_OPTIONS), options);
    const IS_PERSIST = PERSIST_ENTRIES || PERSIST_ENTRIES_STATE;
    const window2 = givenWindow != null ? givenWindow : globalWindow;
    ...
    const historyInitialState = history2 == null ? void 0 : history2.state;
    let initialMeta = {
      [NavigationMeta]: true,
      currentIndex: -1,
      entries: [],
    ...
    if (!initialEntries.length) {
      let url = void 0;
      if ((_a6 = window2.location) == null ? void 0 : _a6.href) {
    ...
    const navigationOptions = {
      ...
      currentIndex: initialMeta == null ? void 0 : initialMeta.currentIndex,
      currentKey: initialMeta == null ? void 0 : initialMeta.key,
      getState(entry) {
    ...
    const navigation3 = givenNavigation != null ? givenNavigation : new Navigation(navigationOptions);
    const pushState = history2 == null ? void 0 : history2.pushState.bind(history2);
    const replaceState = history2 == null ? void 0 : history2.replaceState.bind(history2);
    const historyGo = history2 == null ? void 0 : history2.go.bind(history2);
    return {
      navigation: navigation3,
      history: history2,
      apply() {
        ...
        if (HISTORY_INTEGRATION) {
          ...
          navigation3.addEventListener("currententrychange", ({ navigationType, from }) => {
            ...
            if (ignoreCurrentEntryChange.delete(key) || !(currentEntry == null ? void 0 : currentEntry.sameDocument))
              return;
          ...
          window2.addEventListener("popstate", (event) => {
            ...
            const foundState = originalState != null ? originalState : state;
  ...
  function matchesAncestor(givenElement, selector) {
    ...
    while (element) {
      ...
      element = (_b4 = element.parentElement) != null ? _b4 : (_a6 = element.getRootNode()) == null ? void 0 : _a6.host;
    }
    return void 0;
...
`);
  ...
  var JS = {
    ...
    exec_pop_focus(_e2, _eventType, _phxEvent, _view, _sourceEl, _el) {
      window.requestAnimationFrame(() => {
  ...
  var serializeForm = (form, metadata, onlyNames = []) => {
    const _a6 = metadata, { submitter } = _a6, meta = __objRest(_a6, ["submitter"]);
    let injectedElement;
    ...
    const toRemove = [];
    formData.forEach((val, key, _index2) => {
  ...
  var View = class _View {
    ...
    getDescendentByEl(el) {
      ...
      if (el.id === this.id) {
        ...
        return (_a6 = this.children[el.getAttribute(PHX_PARENT_ID)]) == null ? void 0 : _a6[el.id];
      }
    }
    ...
    joinDeadView() {
      ...
      if (body && !this.isPhxView(body) && !this.isPhxView(document.firstElementChild)) {
        ...
        window.requestAnimationFrame(() => {
          var _a6;
          view.execNewMounted();
          this.maybeScroll((_a6 = history.state) == null ? void 0 : _a6.scroll);
        });
      }
    }
    viewSelector() {
